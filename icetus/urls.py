...
<<<<<<< HEAD
                       ...
                       url('^admin/product-sku-attribute-manage/$','shopcart.myadmin.product.product_sku_attribute_manage',
...
=======
	...
	url('^admin/product-oper/$', 'shopcart.myadmin.product.oper',name='admin_product_oper'),
	url('^admin/product/$', 'shopcart.myadmin.product.product_list',name='admin_product_list'),
	url('^admin/product/product-export/$', 'shopcart.myadmin.product.product_export',name='admin_product_export'),
	url('^admin/product/product-import/$', 'shopcart.myadmin.product.product_import',name='admin_product_import'),
